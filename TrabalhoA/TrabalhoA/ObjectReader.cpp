...
Object* ObjectReader::loadSimpleOBJ(string filepath, Shader* shader, glm::vec3 color, glm::vec3 position, glm::vec3 scale) {
	...
	Object* object = new Object(shader, vbuffer.size() / 11, VAO, position, scale);
